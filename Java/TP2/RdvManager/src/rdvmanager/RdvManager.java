...
public class RdvManager {
    ...
    final int SPANDEFAULT = 30;
    final String SAVEFILE = "username_old.csv";
    // TODO: EXO 4.1
    private static final Logger pckLogger = Logger.getLogger("rdvmanager");
    /**
    ...
    private int readSpan() {
        ...
        while (span == 0 && this.input.hasNext()) {
            ...
            if (sText.equals(".")) {
                ...
                if (span < 0 || span > 12 * 60) { // DONE: EXO 1.10
                    this.toUser("Not a valid span, default initialisation : 30 minutes");
                    span = SPANDEFAULT;
                }
            }
        }
    ...
    public void doPrint() {
        ...
        LocalDate dStart = this.readDate();
        LocalTime tStart = this.readTime();
        // DONE: EXO 1.7
        // Read the ending time
        LocalDate dEnd = this.readDate();
        LocalTime tEnd = this.readTime();
        this.toUser("List of rendezvous between" + dStart + " " + tStart + " and " + dEnd + " " + tEnd +"\n");
        // DONE: EXO 1.7
        //call of printFromTo
        this.rdvList.printFromTo(this.output, LocalDateTime.of(dStart, tStart), LocalDateTime.of(dEnd, tEnd));
    }
    ...
    public void doClear() { // TODO: EXO 1.8, 1.9
        ...
        LocalTime tEnd = this.readTime();
        this.toUser("List of rendezvous between" + dStart + " " + tStart + " and " + dEnd + " " + tEnd +"\n");
        //call of removeFromTo
        this.rdvList.removeFromTo(this.output, LocalDateTime.of(dStart, tStart), LocalDateTime.of(dEnd, tEnd));
    }
